package catalog.Automation.common;
...
public class CommonMethods {
	...
	{		
		...
		if(OSName.toLowerCase().contains("windows")){
			File IEfile = new File("C:\\Users\\Neelam\\Desktop\\Selenium Practice\\selenium\\Drivers\\IEDriverServer.exe");
			System.setProperty("webdriver.ie.driver", IEfile.getAbsolutePath());		
			File chromedriver = new File("C:\\Users\\Neelam\\Desktop\\Selenium Practice\\selenium\\Drivers\\chromedriver.exe");
			System.setProperty("webdriver.chrome.driver", chromedriver.getAbsolutePath());
			
			logger.info("Browser = " + browser);
			
			if (browser.equalsIgnoreCase("FireFox")) {
			System.setProperty("webdriver.gecko.driver", "C:\\Users\\Neelam\\Desktop\\Selenium Practice\\selenium\\Drivers\\geckodriver.exe");
